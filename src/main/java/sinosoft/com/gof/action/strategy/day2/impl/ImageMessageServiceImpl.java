...
@Service(value = "imagesServiceImp")
@MsgHandler(MsgType.IMAGE)
public class ImageMessageServiceImpl implements MessageSerciceI {

	@Override
	public void dealMessageService(Message message) {
		System.err.println("处理IMAGE信息:type :"+message.getMsg()+",内容："+message.getContent());
