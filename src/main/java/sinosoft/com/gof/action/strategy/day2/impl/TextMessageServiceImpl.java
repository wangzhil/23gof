...
@Service(value = "textServiceImp")
public class TextMessageServiceImpl implements MessageSerciceI {

	@Override
	public void dealMessageService(Message message) {
		System.err.println("处理TEXT信息:type :"+message.getMsg()+",内容："+message.getContent());
